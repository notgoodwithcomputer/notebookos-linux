...
# This old codebase predates GCC 14, which turned -Wincompatible-pointer-types
# into an error by default (execstack.c passes const char ** where char ** is
# expected). Relax it back to a warning so it builds with the host GCC 14.
HOST_PRELINK_CROSS_CONF_ENV = \
	CFLAGS="$(HOST_CFLAGS) -Wno-error=incompatible-pointer-types -Wno-incompatible-pointer-types"
