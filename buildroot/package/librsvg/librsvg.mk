...
# Notebook OS: keep the gdk-pixbuf loader off (cross-compiling a loader into the
# target loaders.cache is unreliable) but BUILD THE TOOLS so rsvg-convert ships —
# the Media viewer shells out to it to rasterise SVG images (see media.py).
LIBRSVG_CONF_OPTS = --disable-pixbuf-loader --enable-tools
