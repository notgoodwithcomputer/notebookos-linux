...
# We need the GObject-introspection typelib (for the Python Terminal app) but
# NOT the Vala bindings: vte 0.66.2's bundled vala sample (bindings/vala/
# app.vala) fails to compile with modern valac ("value is less accessible than
# constant"). gir and vapi are independent, so keep gir, drop vapi.
ifeq ($(BR2_PACKAGE_GOBJECT_INTROSPECTION),y)
VTE_CONF_OPTS += -Dgir=true -Dvapi=false
